 ...
 * @Author: your name
 * @Date: 2019-10-02 18:41:55
 * @LastEditTime: 2019-10-03 21:12:30
...
#define AIRKISS_ENABLE_CRYPT 1
	...
	typedef struct
	{
		void *appid;	/*!< APP identifer data 微信公众号id */
		void *deviceid; /*!< Device identifer data 设备id */
...
#define AIRKISS_CONFIG_INFO_DEFAULT()                \
	{                                                \
		...
		.aes_key = NULL, .ssdp_notify_enable = true, \
	}
